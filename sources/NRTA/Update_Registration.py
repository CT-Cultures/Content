...
contents_of_registrations['许可证号'] = contents_of_registrations['许可证号'].apply(lambda x:
                            x.lstrip('\n+').lstrip('\t+').rstrip('\t+').rstrip('\n+'))
    
contents_of_registrations['备注'] = contents_of_registrations['备注'].apply(lambda x:
                            x.lstrip('\n+').lstrip('\t+').rstrip('\t+').rstrip('\n+'))
>>>>>>> 6d31cf15917b657c55dc03711768a4ac19751948
