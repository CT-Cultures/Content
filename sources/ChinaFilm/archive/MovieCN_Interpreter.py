...
class Clean(object):  # used to handle exceptions from web sources
    ...
    def correct_Releaseerror(self, info_release):
        pos_release = 0
        info_release1 = info_release
        while pos_release < len(info_release1):
            if (info_release1[pos_release][0] == '' and
                info_release1[pos_release][1] == '' and
                info_release1[pos_release][2] == '' and
                info_release1[pos_release][3] == '' and
                info_release1[pos_release][5] == ''):
                del info_release1[pos_release]
            pos_release = pos_release + 1
        return info_release1
...
# 对于 旬 的处理
    ...
    def ReleaseInfo(self):
        ...
        all_releases = cleaner.correct_Releaseerror(all_releases)
        return all_releases
######################################################################
